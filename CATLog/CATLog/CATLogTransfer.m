...
@class CATLogTransferPacket;

NSString *const CATLogTransferException = @"CATLogTransferException";
NSString *const CATLogTransferErrorDomain = @"CATLogTransferErrorDomain";

NSString *const CATLogTransferQueueName = @"CATLogTransfer";
NSString *const CATLogTransferThreadName = @"CATLogTransfer-CFStream";

enum CATLogTransferFlags
{
...
@interface CATLogTransfer ()
{
    ...
    CATLogTransferReceiveFilterBlock receiveFilterBlock;
    dispatch_queue_t receiveFilterQueue;
    BOOL receiveFilterAsync;
    
    CATLogTransferSendFilterBlock sendFilterBlock;
    ...
    CATLogTransferPacket *currentSend;
...
/**
 * The CATLogTransferSendPacket encompasses the instructions for a single send/write.
 **/
@interface CATLogTransferPacket : NSObject {
@public
    NSData *buffer;
...
@implementation CATLogTransferPacket
...
@interface CATLogTransferSpecialPacket : NSObject {
@public
    //	uint8_t type;
...
@implementation CATLogTransferSpecialPacket
...
- (id)initWithDelegate:(id <CATLogTransferDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
    ...
    if ((self = [super init]))
    {
        ...
        {
            socketQueue = dispatch_queue_create([CATLogTransferQueueName UTF8String], NULL);
        }
...
- (void)setDelegate:(id <CATLogTransferDelegate>)newDelegate synchronously:(BOOL)synchronously
{
...
- (void)setDelegate:(id <CATLogTransferDelegate>)newDelegate
{
    [self setDelegate:newDelegate synchronously:NO];
}

- (void)synchronouslySetDelegate:(id <CATLogTransferDelegate>)newDelegate
{
...
- (void)setDelegate:(id <CATLogTransferDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue synchronously:(BOOL)synchronously
{
    dispatch_block_t block = ^{
...
- (void)setDelegate:(id <CATLogTransferDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
    [self setDelegate:newDelegate delegateQueue:newDelegateQueue synchronously:NO];
}

- (void)synchronouslySetDelegate:(id <CATLogTransferDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
...
- (void)notifyDidConnectToAddress:(NSData *)anAddress
{
    ...
    if (delegateQueue && [theDelegate respondsToSelector:@selector(transfer:didConnectToAddress:)])
    {
        NSData *address = [anAddress copy]; // In case param is NSMutableData
        
        dispatch_async(delegateQueue, ^{ @autoreleasepool {
            
            [theDelegate transfer:self didConnectToAddress:address];
        }});
    }
}
...
- (void)notifyDidNotConnect:(NSError *)error
{
    ...
    __strong id theDelegate = delegate;
    if (delegateQueue && [theDelegate respondsToSelector:@selector(transfer:didNotConnect:)])
    {
        dispatch_async(delegateQueue, ^{ @autoreleasepool {
            
            [theDelegate transfer:self didNotConnect:error];
        }});
    }
}
...
- (void)notifyDidSendDataWithTag:(long)tag
{
    ...
    __strong id theDelegate = delegate;
    if (delegateQueue && [theDelegate respondsToSelector:@selector(transfer:didSendDataWithTag:)])
    {
        dispatch_async(delegateQueue, ^{ @autoreleasepool {
            
            [theDelegate transfer:self didSendDataWithTag:tag];
        }});
    }
}
...
- (void)notifyDidNotSendDataWithTag:(long)tag dueToError:(NSError *)error
{
    ...
    __strong id theDelegate = delegate;
    if (delegateQueue && [theDelegate respondsToSelector:@selector(transfer:didNotSendDataWithTag:dueToError:)])
    {
        dispatch_async(delegateQueue, ^{ @autoreleasepool {
            
            [theDelegate transfer:self didNotSendDataWithTag:tag dueToError:error];
        }});
    }
}
...
- (void)notifyDidReceiveData:(NSData *)data fromAddress:(NSData *)address withFilterContext:(id)context
{
    ...
    SEL selector = @selector(transfer:didReceiveData:fromAddress:withFilterContext:);
    ...
    if (delegateQueue && [theDelegate respondsToSelector:selector])
    {
        dispatch_async(delegateQueue, ^{ @autoreleasepool {
            ...
            [theDelegate transfer:self didReceiveData:data fromAddress:address withFilterContext:context];
        }});
    }
}
...
- (void)notifyDidCloseWithError:(NSError *)error
{
    ...
    __strong id theDelegate = delegate;
    if (delegateQueue && [theDelegate respondsToSelector:@selector(transferDidClose:withError:)])
    {
        dispatch_async(delegateQueue, ^{ @autoreleasepool {
            
            [theDelegate transferDidClose:self withError:error];
        }});
    }
}
...
- (NSError *)badConfigError:(NSString *)errMsg
{
    ...
    return [NSError errorWithDomain:CATLogTransferErrorDomain
                               code:CATLogTransferBadConfigError
                           userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
    ...
    return [NSError errorWithDomain:CATLogTransferErrorDomain
                               code:CATLogTransferBadParamError
                           userInfo:userInfo];
}
...
{
    NSString *errMsg = NSLocalizedStringWithDefaultValue(@"CATLogTransferSendTimeoutError",
                                                         @"CATLogTransfer", [NSBundle mainBundle],
                                                         @"Send operation timed out", nil);
    
    NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
    
    return [NSError errorWithDomain:CATLogTransferErrorDomain
                               code:CATLogTransferSendTimeoutError
                           userInfo:userInfo];
}

- (NSError *)socketClosedError
{
    NSString *errMsg = NSLocalizedStringWithDefaultValue(@"CATLogTransferClosedError",
                                                         @"CATLogTransfer", [NSBundle mainBundle],
                                                         @"Socket closed", nil);
    
    NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
    
    return [NSError errorWithDomain:CATLogTransferErrorDomain code:CATLogTransferClosedError userInfo:userInfo];
}
...
- (BOOL)connectToHost:(NSString *)host onPort:(uint16_t)port error:(NSError **)errPtr
{
    ...
    dispatch_block_t block = ^{ @autoreleasepool {
        ...
        CATLogTransferSpecialPacket *packet = [[CATLogTransferSpecialPacket alloc] init];
...
- (void)maybeConnect
{
    ...
    BOOL sendQueueReady = [currentSend isKindOfClass:[CATLogTransferSpecialPacket class]];
    
    if (sendQueueReady)
    {
        CATLogTransferSpecialPacket *connectPacket = (CATLogTransferSpecialPacket *)currentSend;
...
- (void)sendData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
    ...
    CATLogTransferPacket *packet = [[CATLogTransferPacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (void)sendData:(NSData *)data toAddress:(NSData *)remoteAddr withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
    ...
    CATLogTransferPacket *packet = [[CATLogTransferPacket alloc] initWithData:data timeout:timeout tag:tag];
    packet->addressFamily = [CATLogTransfer familyFromAddress:remoteAddr];
...
{
    CATLogTransferSendFilterBlock newFilterBlock = NULL;
...
- (void)maybeDequeueSend
{
    ...
    if (currentSend == nil)
    {
        ...
        while ([sendQueue count] > 0)
        {
            ...
            if ([currentSend isKindOfClass:[CATLogTransferSpecialPacket class]])
            {
                [self maybeConnect];
...
- (void)doPreSend
{
    ...
    if (sendFilterBlock && sendFilterQueue)
    {
        ...
        if (sendFilterAsync)
        {
            ...
            CATLogTransferPacket *sendPacket = currentSend;
...
- (void)setReceiveFilter:(CATLogTransferReceiveFilterBlock)filterBlock
          ...
          isAsynchronous:(BOOL)isAsynchronous
{
    CATLogTransferReceiveFilterBlock newFilterBlock = NULL;
    dispatch_queue_t newFilterQueue = NULL;
...
+ (void)listenerThread
{
    @autoreleasepool {
        ...
        [[NSThread currentThread] setName:CATLogTransferThreadName];
...
+ (void)addStreamListener:(CATLogTransfer *)asyncUdpSocket
{
    LogTrace();
...
+ (void)removeStreamListener:(CATLogTransfer *)asyncUdpSocket
{
    LogTrace();
    NSAssert([NSThread currentThread] == listenerThread, @"Invoked on wrong thread");
...
{
    @autoreleasepool {
        CATLogTransfer *asyncUdpSocket = (__bridge CATLogTransfer *)pInfo;
